...
public static class DialingCodes
{
	...
	public static string FindLongestCountryName(Dictionary<int, string> existingDictionary) => existingDictionary.Count > 0 ? existingDictionary.MaxBy(d => d.Value.Length).Value : string.Empty;
}